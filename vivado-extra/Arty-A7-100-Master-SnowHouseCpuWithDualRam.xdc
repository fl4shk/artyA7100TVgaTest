...
##set_clock_groups -async -group [list [get_clocks core_clock_clk_wiz_0] [get_clocks peripheral_clock_clk_wiz_0]]
...
##set_property -dict {PACKAGE_PIN C10 IOSTANDARD LVCMOS33} [get_ports io_inpResetReadSnesButtons]
##set_property -dict {PACKAGE_PIN A10 IOSTANDARD LVCMOS33} [get_ports io_inpReadSnesButtons]
#
## RGB LEDs
#set_property -dict {PACKAGE_PIN E1 IOSTANDARD LVCMOS33} [get_ports io_led0_b]
#set_property -dict {PACKAGE_PIN F6 IOSTANDARD LVCMOS33} [get_ports io_led0_g]
#set_property -dict {PACKAGE_PIN G6 IOSTANDARD LVCMOS33} [get_ports io_led0_r]
#set_property -dict {PACKAGE_PIN G4 IOSTANDARD LVCMOS33} [get_ports io_led1_b]
#set_property -dict {PACKAGE_PIN J4 IOSTANDARD LVCMOS33} [get_ports io_led1_g]
#set_property -dict {PACKAGE_PIN G3 IOSTANDARD LVCMOS33} [get_ports io_led1_r]
#set_property -dict {PACKAGE_PIN H4 IOSTANDARD LVCMOS33} [get_ports io_led2_b]
#set_property -dict {PACKAGE_PIN J2 IOSTANDARD LVCMOS33} [get_ports io_led2_g]
#set_property -dict {PACKAGE_PIN J3 IOSTANDARD LVCMOS33} [get_ports io_led2_r]
#set_property -dict {PACKAGE_PIN K2 IOSTANDARD LVCMOS33} [get_ports io_led3_b]
#set_property -dict {PACKAGE_PIN H6 IOSTANDARD LVCMOS33} [get_ports io_led3_g]
#set_property -dict {PACKAGE_PIN K1 IOSTANDARD LVCMOS33} [get_ports io_led3_r]
#
## LEDs
...
#set_property -dict {PACKAGE_PIN T10 IOSTANDARD LVCMOS33} [get_ports io_led3]
#
### Buttons
...
#
## Pmod Header JA
#set_property -dict { PACKAGE_PIN G13   IOSTANDARD LVCMOS33 } [get_ports { io_ja[0] }]; #IO_0_15 Sch=ja[1]
#set_property -dict { PACKAGE_PIN B11   IOSTANDARD LVCMOS33 } [get_ports { io_ja[1] }]; #IO_L4P_T0_15 Sch=ja[2]
#set_property -dict { PACKAGE_PIN A11   IOSTANDARD LVCMOS33 } [get_ports { io_ja[2] }]; #IO_L4N_T0_15 Sch=ja[3]
#set_property -dict { PACKAGE_PIN D12   IOSTANDARD LVCMOS33 } [get_ports { io_ja[3] }]; #IO_L6P_T0_15 Sch=ja[4]
#set_property -dict { PACKAGE_PIN D13   IOSTANDARD LVCMOS33 } [get_ports { io_ja[4] }]; #IO_L6N_T0_VREF_15 Sch=ja[7]
#set_property -dict { PACKAGE_PIN B18   IOSTANDARD LVCMOS33 } [get_ports { io_ja[5] }]; #IO_L10P_T1_AD11P_15 Sch=ja[8]
#set_property -dict { PACKAGE_PIN A18   IOSTANDARD LVCMOS33 } [get_ports { io_ja[6] }]; #IO_L10N_T1_AD11N_15 Sch=ja[9]
#set_property -dict { PACKAGE_PIN K16   IOSTANDARD LVCMOS33 } [get_ports { io_ja[7] }]; #IO_25_15 Sch=ja[10]
#
## Pmod Header JB
#set_property -dict { PACKAGE_PIN E15   IOSTANDARD LVCMOS33 } [get_ports { io_jb[0] }]; #IO_L11P_T1_SRCC_15 Sch=jb_p[1]
#set_property -dict { PACKAGE_PIN E16   IOSTANDARD LVCMOS33 } [get_ports { io_jb[1] }]; #IO_L11N_T1_SRCC_15 Sch=jb_n[1]
#set_property -dict { PACKAGE_PIN D15   IOSTANDARD LVCMOS33 } [get_ports { io_jb[2] }]; #IO_L12P_T1_MRCC_15 Sch=jb_p[2]
#set_property -dict { PACKAGE_PIN C15   IOSTANDARD LVCMOS33 } [get_ports { io_jb[3] }]; #IO_L12N_T1_MRCC_15 Sch=jb_n[2]
#set_property -dict { PACKAGE_PIN J17   IOSTANDARD LVCMOS33 } [get_ports { io_jb[4] }]; #IO_L23P_T3_FOE_B_15 Sch=jb_p[3]
#set_property -dict { PACKAGE_PIN J18   IOSTANDARD LVCMOS33 } [get_ports { io_jb[5] }]; #IO_L23N_T3_FWE_B_15 Sch=jb_n[3]
#set_property -dict { PACKAGE_PIN K15   IOSTANDARD LVCMOS33 } [get_ports { io_jb[6] }]; #IO_L24P_T3_RS1_15 Sch=jb_p[4]
#set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { io_jb[7] }]; #IO_L24N_T3_RS0_15 Sch=jb_n[4]
#
## Pmod Header JC
...
##[get_ports { jc[0] }];
#set_property -dict {PACKAGE_PIN U12 IOSTANDARD LVCMOS33} [get_ports io_outpVgaColR_0]
##[get_ports { jc[1] }];
#set_property -dict {PACKAGE_PIN V12 IOSTANDARD LVCMOS33} [get_ports io_outpVgaColR_1]
##[get_ports { jc[2] }];
#set_property -dict {PACKAGE_PIN V10 IOSTANDARD LVCMOS33} [get_ports io_outpVgaColR_2]
##[get_ports { jc[3] }];
#set_property -dict {PACKAGE_PIN V11 IOSTANDARD LVCMOS33} [get_ports io_outpVgaColR_3]
##[get_ports { jc[4] }];
#set_property -dict {PACKAGE_PIN U14 IOSTANDARD LVCMOS33} [get_ports io_outpVgaColB_0]
##[get_ports { jc[5] }];
#set_property -dict {PACKAGE_PIN V14 IOSTANDARD LVCMOS33} [get_ports io_outpVgaColB_1]
##[get_ports { jc[6] }];
#set_property -dict {PACKAGE_PIN T13 IOSTANDARD LVCMOS33} [get_ports io_outpVgaColB_2]
##[get_ports { jc[7] }];
#set_property -dict {PACKAGE_PIN U13 IOSTANDARD LVCMOS33} [get_ports io_outpVgaColB_3]
#
## Pmod Header JD
##[get_ports { jd[0] }];
#set_property -dict {PACKAGE_PIN D4 IOSTANDARD LVCMOS33} [get_ports io_outpVgaColG_0]
##[get_ports { jd[1] }];
#set_property -dict {PACKAGE_PIN D3 IOSTANDARD LVCMOS33} [get_ports io_outpVgaColG_1]
##[get_ports { jd[2] }];
#set_property -dict {PACKAGE_PIN F4 IOSTANDARD LVCMOS33} [get_ports io_outpVgaColG_2]
##[get_ports { jd[3] }];
#set_property -dict {PACKAGE_PIN F3 IOSTANDARD LVCMOS33} [get_ports io_outpVgaColG_3]
##[get_ports { jd[4] }];
#set_property -dict {PACKAGE_PIN E2 IOSTANDARD LVCMOS33} [get_ports io_outpVgaHsync]
##[get_ports { jd[5] }];
#set_property -dict {PACKAGE_PIN D2 IOSTANDARD LVCMOS33} [get_ports io_outpVgaVsync]
...
#[get_ports {ck_io0}];
set_property -dict {PACKAGE_PIN V15 IOSTANDARD LVCMOS33} [get_ports io_snesCtrl_outpClk]
#set_output_delay -max 0.1 [get_ports io_snesCtrl_outpClk]
#[get_ports {ck_io1}];
set_property -dict {PACKAGE_PIN U16 IOSTANDARD LVCMOS33} [get_ports io_snesCtrl_outpLatch]
#set_output_delay -max 0.1 [get_ports io_snesCtrl_outpLatch]
#[get_ports {ck_io2}];
set_property -dict {PACKAGE_PIN P14 IOSTANDARD LVCMOS33} [get_ports io_snesCtrl_inpData]
#set_input_delay -max 0.1 [get_ports io_snesCtrl_inpData]
...
set_property -dict {PACKAGE_PIN U11 IOSTANDARD LVCMOS33} [get_ports io_ck_io26]
#set_output_delay -max 0.1 [get_ports io_ck_io26]
